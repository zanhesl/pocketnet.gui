...
var PlyrEx = async function(target, options, clbk, readyCallback) {
    ...
    var _error = function(errorMessage) {
        var new_target = document.createElement('div');
            ...
            new_target.innerHTML = `<div class="errorcntplyrex"><div class="errorcntTableWrapper"><div class="errorcntTable"><div class="errorcntCell">${errorMessage || 'Error loading video.'}</div></div></div></div>`;
